...
Policy = GetWritePolicy(Offset, Mode)

若 RO → EFI_ACCESS_DENIED

若 Dangerous 且未解鎖 → EFI_ACCESS_DENIED

讀固定長度 hex（2/4/8 digits）

寫入（8/16/32）

讀回 verify（提示 masked/ignored/RO）
